...
namespace FollowMe
{
    ...
    public class InterestWorker_AmbulanceChaser : InterestWorker
    {
        ...
        {
            if ( !( thing is Pawn pawn ) ) return 0;
    ...
    public class InterestWorker_Attenborough : InterestWorker
    {
        ...
        public override float InterestFor( Thing thing )
        {
            if ( !( thing is Pawn pawn ) ) return 0f;
            ...
            var commonality = pawn.RaceProps.wildBiomes?.Find( br => br.biome == Find.CurrentMap.Biome )?.commonality;
    ...
    public class InterestWorker_FlogIt: InterestWorker
    {
        ...
        public override float InterestFor( Thing thing )
        {
            ...
            var interest = thing.GetStatValue( StatDefOf.MarketValue );
